  ...
  return (
    <html lang="en" className="h-full">
      ...
      <body>
        <print-container>
          <print-card>
            <header>Your turn</header>
            <ol>
              <li>Gather energy</li>
              <li>
                Perform actions (until out of energy)
                <ul>
                  <li>Move (then handle events)</li>
                  <li>Use a goal card</li>
                </ul>
                <ul>
                  <li>Request a mission</li>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>1 card</td>
                  <td>
                    roll six sided die then discards that many resource cards
                  </td>
                </tr>
                <tr>
                  <td>blank</td>
