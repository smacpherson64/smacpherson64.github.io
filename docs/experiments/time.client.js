...
// src/experiments/time.client.tsx
var import_react = __toESM(require_react());
var import_client = __toESM(require_client());
var import_jsx_runtime = __toESM(require_jsx_runtime());
function App({ zones: zones2, fullSize: fullSize2 }) {
  const unit = 100 / fullSize2;
  const markerArray = (0, import_react.useMemo)(
    () => Array.from({ length: fullSize2 }),
    [fullSize2]
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "w-full min-h-screen relative pt-16 pb-48 text-xs", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "grid grid-cols-[20%_1fr] fixed top-0 w-full p-2 z-0", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { "aria-hidden": true }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { "data-name": "markers", className: "relative w-full h-[2em]", children: backgroundGrid })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "grid grid-cols-[20%_1fr] fixed top-0 w-full p-2 bg-slate-800 z-10", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { "aria-hidden": true }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { "data-name": "markers", className: "relative w-full h-[2em]", children: markerNumbers }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "font-bold  h-[2em]", children: "UTC" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "relative w-full", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "grid grid-cols-[20%_1fr] min-h-screen p-2 w-full gap-y-4", children: zones2.map((data) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "flex flex-col leading-none gap-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "abbr",
          {
            title: [data.timeZone, data.region, data.offset].join(" "),
            className: "font-bold md:hidden underline decoration-dotted",
            children: data.abbreviatedTimeZone
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "md:hidden text-slate-400", children: data.offset === data.abbreviatedTimeZone ? " " : data.offset }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hidden md:block font-bold", children: [
          data.timeZone,
          " ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hidden md:block text-slate-400", children: data.region })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "relative w-full", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "div",
        {
    ...
    ] }, [data.region, data.timeZone].join(""))) })
  ] });
}
function Line() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative h-3 w-full text-white", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute h-3 w-[2px] left-0 top-0 bg-current" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute h-3 w-[2px] right-0 top-0 bg-current" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute h-[2px] w-full bg-current" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute h-2 w-[1px] left-1/2 transform -translate-x-1/2 top-0 bg-current" })
  ] });
}
function getNumericOffset(offset) {
  if (!offset) return 0;
  const [hour, minute] = (offset.replace("GMT", "") || "0").split(":").map(Number);
  if (!minute) return hour;
  const result = Math.abs(hour) + Math.abs(minute) / 60;
  return hour < 0 ? -result : +result;
}
function getAllTimezones() {
  const timezones = [];
  for (const region of Intl.supportedValuesOf("timeZone")) {
    const result = {
      region: "",
      timeZone: "",
      abbreviatedTimeZone: "",
    ...
    Intl.DateTimeFormat(void 0, { timeZone: region, timeZoneName: "long" }).formatToParts().forEach((part) => {
      if (part.type === "timeZoneName") {
        result.region = region;
        result.timeZone = part.value;
      }
    });
    Intl.DateTimeFormat(void 0, { timeZone: region, timeZoneName: "short" }).formatToParts().forEach((part) => {
      if (part.type === "timeZoneName") {
...
var zones = getAllTimezones();
var earliestOffset = zones[0].numericOffset;
var latestOffset = zones[zones.length - 1].numericOffset;
var fullDay = 24;
var fullSize = Math.abs(earliestOffset) + Math.abs(latestOffset) + fullDay + 1;
var root = (0, import_client.createRoot)(document.body);
root.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, { zones, fullSize }));
